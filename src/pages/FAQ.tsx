...
const faqs = [
  {
    icon: Truck,
    q: "هل توفرون التوصيل لجميع ولايات الجزائر؟",
    a: "نعم، نوصل إلى جميع الـ 58 ولاية عبر شركاء توصيل موثوقين لضمان وصول طلبك بأمان.",
  },
  {
    icon: Clock,
    q: "كم تستغرق مدة التوصيل؟",
    a: "عادة ما يستغرق التوصيل بين 24 إلى 72 ساعة حسب الولاية والمنطقة.",
  },
  {
    icon: ShieldCheck,
    q: "هل الحواسيب والقطع أصلية؟",
    a: "نعم، جميع المنتجات أصلية 100% ومستوردة من علامات تجارية وموردين معتمدين.",
  },
  {
    icon: Award,
    q: "هل المنتجات تأتي مع ضمان؟",
    a: "نعم، جميع المنتجات تشمل ضماناً. مدة الضمان تختلف حسب نوع المنتج والعلامة التجارية.",
  },
  {
    icon: Banknote,
    q: "هل يمكنني الدفع عند الاستلام؟",
    a: "نعم، خدمة الدفع عند الاستلام متوفرة في معظم ولايات الجزائر.",
  },
  {
    icon: Cpu,
    q: "هل يمكنني طلب تجميع حاسوب مخصص؟",
    a: "نعم، يمكن للعملاء اختيار القطع وطلب تجميع حاسوب ألعاب أو حاسوب احترافي حسب الطلب.",
  },
  {
    icon: Package,
    q: "ماذا لو وصل المنتج تالفاً؟",
    a: "تواصل معنا فوراً خلال 24 ساعة وسنساعدك في الاستبدال أو الإرجاع.",
  },
  {
    icon: Headphones,
    q: "هل توفرون دعماً تقنياً؟",
    a: "نعم، فريقنا يساعد العملاء في اختيار القطع المناسبة ويوفر دعماً تقنياً بعد البيع.",
  },
];
